...
# $IP6T -A INPUT -p udp -s $LL6 -d $MULTICAST6_8 --sport 5353 --dport 5353 -j ACCEPT
# $IP6T -A INPUT -p udp -s $ULA -d $MULTICAST6_8 --sport 5353 --dport 5353 -j ACCEPT
...
# $IP6T -A OUTPUT -p udp -s $LL6 -d $MULTICAST6_8 --sport 5353 --dport 5353 -j ACCEPT
# $IP6T -A OUTPUT -p udp -s $ULA -d $MULTICAST6_8 --sport 5353 --dport 5353 -j ACCEPT
...
# $IP4T -A OUTPUT -p udp -s $PRIVNET4_16 -m multiport --dport 27000:27100 -j ACCEPTx
# $IP6T -A OUTPUT -p udp -s $LL6 -m multiport --dport 27000:27100 -j ACCEPT
# $IP6T -A OUTPUT -p udp -s $ULA -m multiport --dport 27000:27100 -j ACCEPT
...
# $IP6T -A OUTPUT -s $IP -d $ULA -j ACCEPT
